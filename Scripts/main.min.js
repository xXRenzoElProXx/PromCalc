var n = function (e) {
    return { floo: e[0], name: e[1], perc: e[2], scor: e[3], sons: [] };
},
    r = function (e, t) {
        ...
        label: {
            es: {
                ...
                common: {
                    ...
                    ".input_score>input2[placeholder]":
                        "Tipo de nota (mínimo 1 caracter)",
                    ".input_score>input3[placeholder]": "Peso%",
                    ".input_score>input4[placeholder]": "Nota",
                    ...
                    "#evaluate": "EVALUAR",
                    "#clear": "LIMPIAR",
                    "#result>.header>.scoreType": "<span>[Peso, Nota]</span>Tipo de nota",
                    ...
                    author: [
                        "Mi nombre es Jared Castro y desarrollé este programa para que los estudiantes de la USIL calcularan sus notas de manera más sencilla.",
                        "¿Tienes alguna <span style='text-decoration:underline;'>sugerencia</span> sobre el funcionamiento de la herramienta? Házmelo saber. Envíame un mensaje a <a href='http://www.google.com/gmail/' target='_blank'>docjaredwp@gmail.com</a>",
                    ],
                },
                result: {
                    ended: {
                        ...
                        return (
                            (s = r.slice(0, -1).map(function (t) {
                                return (function (e) {
                                    ...
                                    for (
                                        a[1] = e.substring(0, t), e = e.substring(t), t = -1;
                                        ++t < e.length && "." != e[t];
                                    ...
                                    if (t != e.length)
                                        (a[3] =
                                            ...
                                            100),
                                            (t += 3);
                                    else for (a[3] = 0, t = -1; ++t < e.length && isNaN(e[t]););
                                    return (
                                        (e = e.substring(t)),
                                        (a[2] =
                                            0 == e.length
                ...
                get: function () {
                    ...
                    for (i = 0; i < o.length; i++)
                        (s = $("input", o[i])),
                            ...
                            (n = parseFloat(n || 0)),
                            l.push([e, t, a, n]);
                    return l.push([0, "PROMEDIO", 100, 0]), l;
                },
                evaluate: function () {
...
(run = function (e) {
    var t = function (e) {
        ...
        s = function (e) {
            ...
            return [[e.floo, e.name, e.perc, e.scor]].concat(t);
        };
    try {
        ...
        $(this).on("click", ".delete", function (e) {
            if ((e.preventDefault(), $(this).parents("#block_scores").length > 0))
                ...
                (a[0].value = $("[name=level]", t).val() || ""),
                    (a[1].value = $("[name=scoreType]", t).val() || ""),
                    (a[2].value = $("[name=weight]", t).val() || ""),
                    (a[3].value = $("[name=score]", t).val() || ""),
                    t.remove();
            }
        }),
            $(this).on("click", ".add", function (e) {
                ...
                if (
                    ...
                    $("[name=level]", t).val(a[0].value),
                        $("[name=scoreType]", t).val(a[1].value),
                        $("[name=weight]", t).val(a[2].value),
                        $("[name=score]", t).val(a[3].value),
    ...
    $("#control").ready(function () {
                ...
                if (void 0 !== c && 0 != c[3]) {
                    ...
                    if (
                        ((o = l(t).map(function (e, a) {
                            return (
                                u + slc(e, a, 0, 20, t[e][3]) + m + "'" + t[e][1] + "'," + d
                            );
                        })),
                            (n +=
                                u +
                        ...
                        var w = parseInt(((S - t[t.length - 1][3] - 0.5) / v) * 100) / 100,
                            I = parseInt(((S - t[t.length - 1][3] + 0.49) / v) * 100) / 100;
                        w < 0 && (w = 0),
                            I > 20 && (I = 20),
                            (s +=
                                u +
        ...
        $(this).on("click", "#clear", function (e) {
            ...
            $(this).on("change", "#language", function (t) {
                var a, n, s;
                for (
                    lang = $(this).val(),
                    s = (label = gd.label[lang]).common,
                    $("#inst").html(label.common["#inst"]),
                    $("#mode>a:nth-child(1)").attr("title", s["#mode>a1[title]"]),
                    $("#mode>a:nth-child(2)>span").html(s["#mode>a2>span"]),
                    $("#mode>a:nth-child(2)").attr("title", s["#mode>a2[title]"]),
                    $("#input_scores").attr(
                        "placeholder",
                        s["#input_scores[placeholder]"]
                    ),
                    a = 1;
                    a < 5;
                    a++
                )
                    $(".input_score>input:nth-child(" + a + ")").attr(
                        "placeholder",
                        s[".input_score>input" + a + "[placeholder]"]
                    );
                for (
                    $("#deletables").html(
                        s["#deletables>if"] + dlt() + s["#deletables>smallest"]
                    ),
                    $("#finalexam").html("<input type='checkbox'>" + s["#finalexam"]),
                    $("#input>[opt=2]>.input_score.static>[name=scoreType]").val(
                        s.finalexam
                    ),
                    $("#evaluate").html(s["#evaluate"]),
                    $("#clear").html(s["#clear"]),
                    void 0 !== scores.chart && e(),
                    $("#result>.header>.scoreType").html(
                        s["#result>.header>.scoreType"]
                    ),
                    $("#result>.header>.weight").html(s["#result>.header>.weight"]),
                    $("#result>.header>.score").html(s["#result>.header>.score"]),
                    $("#mode>a.active").trigger("click"),
                    $("#apps").html(s["#apps"]),
                    $("#faqr").html(s["#faqr"]),
                    n = "",
                    a = 0;
    ...
    $("#rsltScore").on("change", "select", function () {
        ...
        (scores.simul[e][3] = parseInt($(this).val())),
            (scores.simul = run(scores.simul)),
            $("span#resultScore").html(
                (1e3 * scores.simul[scores.simul.length - 1][3]) / 1e3
            );
    }),
